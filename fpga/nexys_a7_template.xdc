...
# Uncomment only if your top-level defines LED[15:0].
...
# Nexys A7 does not provide onboard pull-ups on the microSD FPGA-side signals.
# Enable weak internal pull-ups so SPI-mode idle/high response behavior is more
# reliable during initialization (CMD line, MISO/DAT0, CS/DAT3, and unused DAT1/2).
...
# SD0 SPI mapped to onboard MicroSD connector (SPI mode).
# - SD_CMD  -> MOSI
# - SD_DAT0 -> MISO
# - SD_DAT3 -> CS
#set_property -dict { PACKAGE_PIN B1    IOSTANDARD LVCMOS33 } [get_ports { sd0_spi_clk }];  # SD_SCK
#set_property -dict { PACKAGE_PIN C1    IOSTANDARD LVCMOS33 } [get_ports { sd0_spi_mosi }]; # SD_CMD
#set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { sd0_spi_miso }]; # SD_DAT0
#set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { sd0_spi_cs }];   # SD_DAT3

# SD1 SPI mapped to PMOD JA for external second card wiring.
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { sd1_spi_cs }];   # JA1
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { sd1_spi_clk }];  # JA2
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { sd1_spi_mosi }]; # JA3
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { sd1_spi_miso }]; # JA4
...
# UART mapped to the onboard USB-UART bridge.
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; # USB-UART TX -> FPGA RX
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; # FPGA TX -> USB-UART RX
