...
set _ddr_pll_cell [get_cells -quiet u_ddr2_infrastructure/plle2_i]
if {[llength $_ddr_pll_cell] > 0} {
    set_property LOC PLLE2_ADV_X1Y1 $_ddr_pll_cell
}

set _ddr_mmcm_cell [get_cells -quiet u_ddr2_infrastructure/gen_mmcm.mmcm_i]
if {[llength $_ddr_mmcm_cell] > 0} {
    set_property LOC MMCME2_ADV_X1Y1 $_ddr_mmcm_cell
}
